...
complete -c tldr -xf -l version -d "print version and exit" -n "__fish_use_subcommand"
complete -c tldr -xf -s h -l help -d "print this help and exit" -n "__fish_use_subcommand"
complete -c tldr -xf -s u -l update -d "update local database" -n "__fish_use_subcommand"
complete -c tldr -xf -s c -l clear-cache -d "clear local database" -n "__fish_use_subcommand"
